...
ENV SERVICE_NAME=gcs-proxy
ENV API_PORT=8080
ENV SERVICE_HANDLER_API_SERVICE_ADDRESS=https://service-handler-api-636548090700.us-central1.run.app
ENV SERVICE_HANDLER_API_SERVICE_TIMEOUT=60

ARG PROJECT_NAME=gcs-proxy
RUN apt-get update
